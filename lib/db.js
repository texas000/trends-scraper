...
async function initializeDatabase() {
  ...
  try {
    ...
    // 4. Migrate search_results: add missing columns if not present
    const migrations = [
    ...
    // 5. Create indices for search_results table
    ...
    // 7. Create indices for trend_searches table
